...
//    AMLTools amlTools = new AMLTools(amlCons);
    ...
    for (int i = 0; i < tb2_string.length; i++) {
      ...
      if ("1".equals(stringChangeName)) {
        ...
        */
        ...
        String amlText = stringProjectID1 + "," + stringOrderNo + "," + orderDate + "," + getFunctionName() + "," + "客戶資料" + "," + stringCustomNo + "," + stringCustomName + "," + strBirthday + "," + indCode + ","
                       + "query18";
    ...
    if (StringUtils.isNotBlank(getValue("AMLText")))
      return value;
    ...
    for (int i = 0; i < tb2_string.length; i++) {
      ...
      if ("1".equals(stringChangeName)) {
        stringSQL = "INSERT  INTO Sale05M091  (OrderNo,RecordNo,auditorship,Nationality,CountryName, CustomNo,CustomName,Percentage,Birthday,MajorName, " 
                  + "PositionName,ZIP,City,Town,Address,Cellphone,Tel,Tel2,eMail,IsBlackList,IsLinked,IsControlList,TrxDateDown) "
                  + "VALUES ('" + stringOrderNo + "'," + "N'" + RecordNo + "', N'" + stringAuditorship + "'," + "N'" + stringNationality + "'," + "N'" + strCountryName + "'," 
                  + "N'" + stringCustomNo + "'," + "N'" + stringCustomName + "',"
