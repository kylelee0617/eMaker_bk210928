...
public class Sale05R192_MLP extends bproc {
  ...
  public String[][] getSale05M084(String[] retSale05M080, String[][] retSale05M086) throws Throwable {
    String sql = "SELECT  distinct T84.CustomName , T84.CustomNo , T91.riskValue " + "FROM Sale05M084 T84 ,  Sale05M091 T91 " + "WHERE DocNo = '" + retSale05M080[0]
        + "' and T84.CustomNo = T91.CustomNo " + "and T91.OrderNo='" + retSale05M086[0][0] + "' and ( (ISNULL(T91.TrxDate,'')<>'' and ISNULL(T91.TrxDate,'') > '"
        + getValue("ReceiveDate") + "' ) or ISNULL(T91.TrxDate,'')='' ) ";
