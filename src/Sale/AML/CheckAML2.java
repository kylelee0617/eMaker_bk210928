...
public class CheckAML2 extends bproc {
  public String getDefaultValue(String value) throws Throwable {
    ...
    //購屋證明單日期
    String[][] order = dbSale.queryFromPool("select a.OrderNo , a.OrderDate from Sale05M090 a where a.OrderNo = '"+strOrderNo+"' ");
    String strOrderDate = order[0][0].trim();
    ...
    if (ret083Table.length > 0) {
      for (int e = 0; e < ret083Table.length; e++) {
        ...
        if ("Y".equals(str083Deputy)) { // 有代繳人
          System.out.println("信用卡制裁名單====>");
          
          // 萊斯Start
          String birth = " ";
          String ind = " ";
          QueryLogBean qBean = mapQueryLog.get(str083DeputyId)==null? null : (QueryLogBean) mapQueryLog.get(str083DeputyId) ;
          if(qBean != null) {
            birth = qBean.getBirthday();
            ind = qBean.getJobType();
          }
          
          String amlText = strOrderNo + "," + strOrderDate + "," + str083DeputyId + "," + str083DeputyName + "," + birth + "," + ind + "," + "query1821";
          ...
          // 客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。(包含控管名單)
          if ("Y".equals(str083Bstatus) || "Y".equals(str083Cstatus)) {
            // Sale05M070
            strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo, ActionNo, Func, RecordType, ActionName ,RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
                + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','信用卡資料','" + strActionName + "','代繳款人" + str083DeputyName
                + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + str083DeputyId + "','" + str083DeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + str083DeputyName
                + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
            dbSale.execFromPool(strSaleSql);
            intRecordNo++;
            // AS400
            strJGENLIBSql = "INSERT INTO PSHBPF (SHB00, SHB01, SHB03, SHB04, SHB05, SHB06A, SHB06B, SHB06, SHB97, SHB98, SHB99) VALUES ('RY', '" + strDocNo + "', '" + RocNowDate
                + "', '" + str083DeputyId + "', '" + str083DeputyName + "', '773', '020', '該客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
            dbJGENLIB.execFromPool(strJGENLIBSql);
            ...
            strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo, ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
                ...
                + str083DeputyId + "','" + str083DeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + str083DeputyName + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','"
                + RocNowDate + "','" + strNowTime + "')";
            dbSale.execFromPool(strSaleSql);
            intRecordNo++;
          }
          ...
          strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
              ...
              + "','" + allCustomName + "','" + strEDate + "','RY','773','005','代繳款人與購買人關係為非二等親內血/姻親，系統檢核提示通報。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // 8
          strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','信用卡資料','" + strActionName + "','不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','008','不動產銷售由第三方代理或繳款，系統檢核提示通報。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // 17
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType,ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','信用卡資料','" + strActionName + "','不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','017','該客戶為控管名單對象，請執行加強式客戶盡職審查並依防制洗錢內部通報作業辦理。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // 17
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType,ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','信用卡資料','" + strActionName + "','不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','018','該客戶為控管名單對象之制裁名單，禁止交易並請依防制洗錢內通報作業會辦法遵室。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // 19
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','信用卡資料','" + strActionName + "', '不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','019','該客戶為公司利害關系人，需依保險業與利害關係人從事放款以外之其他交易管理辦法執行。','" + empNo + "','" + RocNowDate + "','" + strNowTime
              + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // 20
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo, ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','信用卡資料','" + strActionName + "', '不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','020','該客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
        }
      }
    ...
    // 6
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','006','同一客戶不動產買賣，簽約前退訂取消購買，應檢核其合理性。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 9
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','009','客戶係來自主管機關所公告防制洗錢與打擊資恐有嚴重缺失之國家或地區，及其他未遵循或未充分遵循之國家或地區，應檢核其合理性。','" + empNo + "','" + RocNowDate + "','" + strNowTime
        + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 10
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','010','自主管機關所公告防制洗錢與打擊資助恐怖份子有嚴重缺失之國家或地區、及其他未遵循或未充分遵循之國家或地區匯入之交易款項，應檢核其合理性。','" + empNo + "','" + RocNowDate + "','"
        + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 11
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','011','交易最終受益人或交易人為主管機關公告之恐怖分子或團體；或國際認定或追查之恐怖組織；或交易資金疑似與恐怖組織有關聯者，應依資恐防制法進行相關作業。','" + empNo + "','" + RocNowDate + "','"
        + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 12
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','012','客戶要求將不動產權利登記予第三人，未能提出任何關聯或拒絕說明之異常狀況。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 15
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','015','要求公司開立取消禁止背書轉讓支票作為給付方式，應檢核是否符合疑似洗錢交易表徵。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 16
    strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo, Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID + "','"
        + allCustomName + "','" + strEDate + "','RY','773','016','要求公司開立撤銷平行線(取消劃線)支票作為給付方式，應檢核是否符合疑似洗錢交易表徵。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
    dbSale.execFromPool(strSaleSql);
    intRecordNo++;
    // 5, 8, 17,18,19,20,21
    if (Double.parseDouble(strCashMoney) != 0) {// 有現金繳費
      if ("Y".equals(strDeputy)) {// 有代繳人
        System.out.println("現金制裁名單====>");
        
        // 萊斯Start
        String birth = " ";
        String ind = " ";
        QueryLogBean qBean = mapQueryLog.get(strDeputyID)==null? null : (QueryLogBean) mapQueryLog.get(strDeputyID) ;
        if(qBean != null) {
          birth = qBean.getBirthday();
          ind = qBean.getJobType();
        }
        
        String amlText = strOrderNo + "," + strOrderDate + "," + strDeputyID + "," + strDeputyName + "," + birth + "," + ind + "," + "query1821";
        setValue("AMLText" , amlText);
        getButton("BtCustAML").doClick();
        errMsg += getValue("AMLText").trim();
        // 萊斯END
        ...
        if ("朋友".equals(strDeputyRelationship) || "其他".equals(strDeputyRelationship)) {
          ...
          dbJGENLIB.execFromPool(strJGENLIBSql);
          /*
           * if("".equals(errMsg)){ errMsg
           * ="現金代繳款人"+strDeputyName+"與客戶"+allOrderName+"非二親等內親屬關係，請依洗錢及資恐防制作業辦理。"; }else{
           * errMsg =errMsg+"\n現金代繳款人"+strDeputyName+"與客戶"+allOrderName+
           * "非二親等內親屬關係，請依洗錢及資恐防制作業辦理。"; }
           */
        ...
        /*
         * if("".equals(errMsg)){ errMsg
         * ="現金代繳款人"+strDeputyName+"代為辦理不動產交易，請依洗錢及資恐防制作業辦理。"; }else{ errMsg
        ...
        if ("Y".equals(bStatus) || "Y".equals(cStatus)) {
          ...
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','現金資料','" + strActionName + "', '代繳款人" + strDeputyName
              + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + strDeputyID + "','" + strDeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + strDeputyName
              + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
          // AS400
          strJGENLIBSql = "INSERT INTO PSHBPF (SHB00, SHB01, SHB03, SHB04, SHB05, SHB06A, SHB06B, SHB06, SHB97, SHB98, SHB99) VALUES ('RY', '" + strDocNo + "', '" + RocNowDate
              + "', '" + strDeputyID + "', '" + strDeputyName + "', '773', '020', '該客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
          dbJGENLIB.execFromPool(strJGENLIBSql);
          /*
           * if("".equals(errMsg)){ errMsg
           * ="現金代繳款人"+strDeputyName+"為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。"; }else{ errMsg
          ...
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','現金資料','" + strActionName + "', '不符合','" + strDeputyID
              + "','" + strDeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + strDeputyName + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate + "','"
              + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
        }
        ...
        if ("Y".equals(rStatus)) {
          ...
          /*
           * if("".equals(errMsg)){ errMsg
           * ="現金代繳款人"+strDeputyName+"為公司利害關系人，請依保險業與利害關係人從事放款以外之其他交易管理辦法執行。"; }else{
           * errMsg
        ...
        strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo,  Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','現金資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','018','客戶為控管名單對象之制裁名單，禁止交易並請依防制洗錢內通報作業會辦法遵室。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 19
        strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
    ...
    if (ret328Table.length > 0) {
      for (int f = 0; f < ret328Table.length; f++) {
        ...
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','銀行資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','007','同一客戶同一營業日現金繳納累計達50萬元(含)以上，須檢核是否符合疑似洗錢交易表徵。','" + empNo + "','" + RocNowDate + "','" + strNowTime
            + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 9
        ...
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','銀行資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','003','同一客戶同一營業日現金繳納累計達50萬元(含)以上，須檢核是否符合疑似洗錢交易表徵。','" + empNo + "','" + RocNowDate + "','" + strNowTime
            + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 4
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','銀行資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','004','同一客戶3個營業日內，累計繳交現金超過50萬元, 系統檢核提示通報。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 6
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        ...
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','銀行資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','009','客戶係來自主管機關所公告防制洗錢與打擊資恐有嚴重缺失之國家或地區，及其他未遵循或未充分遵循之國家或地區，應檢核其合理性。','" + empNo + "','" + RocNowDate + "','"
            + strNowTime + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 11
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "', '收款','銀行資料','" + strActionName + "', '不適用','" + allCustomID
            + "','" + allCustomName + "','" + strEDate + "','RY','773','011','交易最終受益人或交易人為主管機關公告之恐怖分子或團體；或國際認定或追查之恐怖組織；或交易資金疑似與恐怖組織有關聯者，應依資恐防制法進行相關作業。','" + empNo + "','"
            + RocNowDate + "','" + strNowTime + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 12
        ...
        if (retPDCZPFTable.length > 0) {
          ...
          if ("優先法高".equals(strCZ07)) {
            ...
            /*
             * if("".equals(errMsg)){ errMsg
             * =strTempMsg+"係來自洗錢及資恐防制有嚴重缺失、未遵循或未充分遵循之國家或地區匯入之款項，請依洗錢及資恐防制作業辦理。"; }else{
             * errMsg =errMsg+"\n"+strTempMsg+
             * "係來自洗錢及資恐防制有嚴重缺失、未遵循或未充分遵循之國家或地區匯入之款項，請依洗錢及資恐防制作業辦理。"; }
             */
        ...
        if ("Y".equals(str328Deputy)) {// 有代繳人
          ...
          String birth = " ";
          String ind = " ";
          QueryLogBean qBean = mapQueryLog.get(str328DeputyId)==null? null : (QueryLogBean) mapQueryLog.get(str328DeputyId) ;
          if(qBean != null) {
            birth = qBean.getBirthday();
            ind = qBean.getJobType();
          }
          
          String amlText = strOrderNo + "," + strOrderDate + "," + str328DeputyId + "," + str328DeputyName + "," + birth + "," + ind + "," + "query1821";
          setValue("AMLText" , amlText);
          getButton("BtCustAML").doClick();
          errMsg += getValue("AMLText").trim();
          // 萊斯END
          ...
          if ("朋友".equals(str328Rlatsh) || "其他".equals(str328Rlatsh)) {
             ...
             * }else{ errMsg =errMsg+"\n銀行代繳款人"+str328DeputyName+"與客戶"+allOrderName+
             * "非二親等內親屬關係，請依洗錢及資恐防制作業辦理。"; }
             */
          ...
          /*
           * if("".equals(errMsg)){ errMsg
           * ="銀行代繳款人"+str328DeputyName+"代為辦理不動產交易，請依洗錢及資恐防制作業辦理。"; }else{ errMsg
          ...
          if ("Y".equals(str328bStatus) || "Y".equals(str328cStatus)) {
            ...
            // AS400
            strJGENLIBSql = "INSERT INTO PSHBPF (SHB00, SHB01, SHB03, SHB04, SHB05, SHB06A, SHB06B, SHB06, SHB97, SHB98, SHB99) VALUES ('RY', '" + strDocNo + "', '" + RocNowDate
                + "', '" + str328DeputyId + "', '" + str328DeputyName + "', '773', '020', '該客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
            dbJGENLIB.execFromPool(strJGENLIBSql);
            /*
             * if("".equals(errMsg)){ errMsg
             * ="銀行代繳款人"+str328DeputyName+"為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。"; }else{ errMsg
            ...
            strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType,ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
                + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','銀行資料','" + strActionName + "','不符合','" + str328DeputyId
                + "','" + str328DeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + str328DeputyName + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate
                + "','" + strNowTime + "')";
            dbSale.execFromPool(strSaleSql);
            intRecordNo++;
          }
          ...
          if ("Y".equals(str328rStatus)) {
            ...
            /*
             * if("".equals(errMsg)){ errMsg
             * ="銀行代繳款人"+str328DeputyName+"為公司利害關系人，請依保險業與利害關係人從事放款以外之其他交易管理辦法執行。"; }else{
             * errMsg
          ...
          strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo, Func, RecordType,ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
              + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','銀行資料','" + strActionName + "','不適用','" + allCustomID
              + "','" + allCustomName + "','" + strEDate + "','RY','773','021','客戶或其受益人、家庭成員及有密切關係之人，為現任、曾任國內外政府或國際組織重要政治性職務，請加強客戶盡職調查，請依洗錢防制作業辦理。','" + empNo + "','" + RocNowDate
              + "','" + strNowTime + "')";
          dbSale.execFromPool(strSaleSql);
          intRecordNo++;
        }
    ...
    if (ret082Table.length > 0) {
      for (int g = 0; g < ret082Table.length; g++) {
        ...
        // 2
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
            + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','票據資料','" + strActionName + "','不適用','" + allCustomID + "','"
            + allCustomName + "','" + strEDate + "','RY','773','002','同一客戶3個營業日內，有2日以現金或匯款達450,000~499,999元, 系統檢核提示通報。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
        dbSale.execFromPool(strSaleSql);
        intRecordNo++;
        // 3
        strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) VALUES ('"
        ...
        if ("Y".equals(str082Deputy)) {// 有代繳人
          ...
          String birth = " ";
          String ind = " ";
          QueryLogBean qBean = mapQueryLog.get(str082DeputyId)==null? null : (QueryLogBean) mapQueryLog.get(str082DeputyId) ;
          if(qBean != null) {
            birth = qBean.getBirthday();
            ind = qBean.getJobType();
          }
          
          String amlText = strOrderNo + "," + strOrderDate + "," + str082DeputyId + "," + str082DeputyName + "," + birth + "," + ind + "," + "query1821";
          setValue("AMLText" , amlText);
          getButton("BtCustAML").doClick();
          errMsg += getValue("AMLText").trim();
          // 萊斯END
          ...
          if ("朋友".equals(str082Rlatsh) || "其他".equals(str082Rlatsh)) {
             ...
             * }else{ errMsg =errMsg+"\n票據代繳款人"+str082DeputyName+"與客戶"+allOrderName+
             * "非二親等內親屬關係，請依洗錢及資恐防制作業辦理。"; }
             */
          ...
          /*
           * if("".equals(errMsg)){ errMsg
           * ="票據代繳款人"+str082DeputyName+"代為辦理不動產交易，請依洗錢及資恐防制作業辦理。"; }else{ errMsg
          ...
          if ("Y".equals(str082Bstatus) || "Y".equals(str082Cstatus)) {
            ...
            strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo,  Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
                + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','票據資料','" + strActionName + "','代繳款人" + str082DeputyName
                + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + str082DeputyId + "','" + str082DeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + str082DeputyName
                + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
            dbSale.execFromPool(strSaleSql);
            intRecordNo++;
            // AS400
            strJGENLIBSql = "INSERT INTO PSHBPF (SHB00, SHB01, SHB03, SHB04, SHB05, SHB06A, SHB06B, SHB06, SHB97, SHB98, SHB99) VALUES ('RY', '" + strDocNo + "', '" + RocNowDate
                + "', '" + str082DeputyId + "', '" + str082DeputyName + "', '773', '020', '該客戶為疑似黑名單對象，請覆核確認後，再進行後續交易。','" + empNo + "','" + RocNowDate + "','" + strNowTime + "')";
            dbJGENLIB.execFromPool(strJGENLIBSql);
            /*
             * if("".equals(errMsg)){ errMsg
             * ="票據代繳款人"+str082DeputyName+"為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。"; }else{ errMsg
            ...
            strSaleSql = "INSERT INTO Sale05M070 (DocNo, OrderNo, ProjectID1, RecordNo,ActionNo,  Func, RecordType, ActionName, RecordDesc, CustomID, CustomName, EDate, SHB00, SHB06A, SHB06B, SHB06,SHB97,SHB98,SHB99)  VALUES ('"
                + strDocNo + "','" + strOrderNo + "','" + strProjectID1 + "','" + intRecordNo + "','" + actionNo + "','收款','票據資料','" + strActionName + "','不符合','" + str082DeputyId
                + "','" + str082DeputyName + "','" + strEDate + "','RY','773','020','代繳款人" + str082DeputyName + "為疑似黑名單對象，請覆核確認後，再進行後續交易相關作業。','" + empNo + "','" + RocNowDate
                + "','" + strNowTime + "')";
            dbSale.execFromPool(strSaleSql);
            intRecordNo++;
          }
          ...
          if ("Y".equals(str082Rstatus)) {
            ...
            /*
             * if("".equals(errMsg)){ errMsg
             * ="票據代繳款人"+str082DeputyName+"為公司利害關系人，請依保險業與利害關係人從事放款以外之其他交易管理辦法執行。"; }else{
             * errMsg
    ...
    if ("Y".equals(rule13)) {
      ...
      /*
       * if("".equals(errMsg)){ errMsg
       * ="客戶"+allCustomName+"以現鈔支付訂金以外各期不動產交易價款，請依洗錢及資恐防制作業辦理。"; }else{ errMsg
    ...
    if ("Y".equals(rule14)) {
      ...
      /*
       * if("".equals(errMsg)){ errMsg
       * ="客戶"+allCustomName+"簽約前(含當日)提前付清自備款，請依洗錢及資恐防制作業辦理。"; }else{ errMsg
