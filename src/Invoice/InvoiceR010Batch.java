		...
		for(int x=0 ; x<A3_PATH.length ; x++){
			...
			*/
			stringSQL = " INSERT InvoR010Batch" +
			 ...
			 /*
				try{
					String PATH_ADOBE_READER = "cmd /c start acrord32"; 
					String ADOBE_READER_PRINT_COMMAND = "/s /h /t"; 
					String SLASH = "/"; 
					String QUOTE = "\""; 
					String SPACE = " "; 
					// Command to be executed 
					String lCommand = PATH_ADOBE_READER + SPACE + ADOBE_READER_PRINT_COMMAND + SPACE + QUOTE + arrayTemp[0] + QUOTE + SPACE + QUOTE + pPrinter + QUOTE;
